...
class EditTankClass extends TankClass {
  ...
  //     Notify.error("Controller Selection Input is empty");
  //     this._Controller = '';
  //   }
  ...
  set Tank_index(value) {
    ...
    if (value) {
      this._Tank_index = parseInt(value);
    } else {
  ...
  set Controller_polling_address(value) {
    ...
    if (value && (value != 0)) {
      this._Controller_polling_address = parseInt(value);
    } else {
